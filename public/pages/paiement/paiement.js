...
app.controller('PaiementController', function ($scope, $routeParams, $http, $interval) {
    ...
    controller.prixTotal = 1000;
    controller.tel = "";

    controller.payer = function () {
        ...
        $http({
            ...
            data: {
                "idbouton": "2",
                "typebouton": "PAIE",
                "_amount": (controller.total * controller.taxe + controller.total).toFixed(0),
                "_tel": controller.tel,
                "_clP": "Hermann*_91",
                "_email": "kembuysarl@gmail.com"
            }
    ...
    controller.payerDonc = function (montant, email, motDePasse) {
        console.log("Paiement en cours")
        $http({
            url: "https://developer.mtn.cm/OnlineMomoWeb/faces/transaction/transactionRequest.xhtml",
            method: "GET",
